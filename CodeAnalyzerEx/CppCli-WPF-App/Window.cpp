...
//Karthik Palepally Muniyappa :modified
///////////////////////////////////////////////////////////////////////////
/*
...
WPFCppCliDemo::WPFCppCliDemo()
{
	...
	int clientPort = 8080;
	std::string clientRepoPath = "..\\..\\ClientRepository\\";
	pChann_ = pObjFact->createMockChannel(pSendr_, pRecvr_, clientPort, clientRepoPath);
	pChann_->start();
	delete pObjFact;
...
void CppCliWindows::WPFCppCliDemo::setButtonsProperties2()
{
...
void CppCliWindows::WPFCppCliDemo::setUpTabContro2()
{
