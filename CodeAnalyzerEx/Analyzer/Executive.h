...
namespace CodeAnalysis
{
  ...
  public:
	...
	std::unordered_map<std::string, std::vector<std::string>> startCodeAnalaysis(std::string category);
  ...
  private:
	...
	std::unordered_map<std::string, std::vector<std::string>> buildLazyTable(DependencyTable &obj);
